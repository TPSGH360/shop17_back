"""
Django settings for shop_17_proj project.
...
SECRET_KEY = "django-insecure-^(xejy**tn=afb+c8$dcf#%%@w#mb1ic)q!i&*cqc==by$))29"
...
WSGI_APPLICATION = "shop_17_proj.wsgi.application"
